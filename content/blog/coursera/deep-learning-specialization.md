...
(b는 고려하지 않고 w만 고려함) 위 그림에서 w가 목표로 해야할 값은 global optimum이다. 만약 기울기가 음수라면, global optimum이 오른쪽에 있을 것이라고 가정한다. 그러므로 다음 w 는 오른쪽으로 이동 (
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzIzNzA0NTk5LC00Nzk1NTU3MDQsLTIwMj
